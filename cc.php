...
if(isset($_GET) and isset($_GET['id']))
{
    ...
    $dato_departamento = carga::getStatic_departamento($_SESSION['user']);
...
.input_tamano {
 ...
 <form name="form2" id="form2" class="form-horizontal" style="text-align: left;">
     <?php echo "<b>Departamento:</b> ". $dato_departamento[0]['departamento']; ?>
     
     <br /><br/> 
                                        <div class="form-group">
                                            <label for="c" class="control-label col-xs-4">Carrera</label>
                                            <div class="col-xs-8">
                                                <?php $c = carga::getStatic_carrera($dato_departamento[0]['id']); ?>
                                                <select name="c" class="form-control" id="c" required onchange="from(this.value, 't', 'cajax/turno.php')">
                                                    ...
                                                    for ($i = 0; $i < count($c); $i++) {
                                                        ?>
                                                            <option value="<?php echo $c[$i]["id"]; ?>"><?php echo $c[$i]["carreras"]; ?></option>
                                                            <?php
                                                    }
                                                    ?>
                                                </select>
     ...
     <div class="form-group">
                        ...
                        ?>
                                | <label for="permitir" style="font-size: 12px;">Ignorar limite de asignatura: <?php echo $permitir[0]["permitir"] == 1 ? "Activado" : "Desactivado"; ?> </label>
    ...
    var parametros = {
            ...
            function anadi_quitar(event, id, a)
            {
                if(a.className === 'add')
                {
                    ...
                    if(BAND)
                    {
                        if(chek == true || (totalH+parseInt(tr.cells[3].innerHTML))<= <?php echo $limite[0]["limite"]; ?>)
                        {
