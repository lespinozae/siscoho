                ...
                <div class="col-xs-12">
                    ...
                    <div class="tab-content">
                        <div id="home" class="tab-pane fade in active">
                            ...
                            <form name="form1" class="form-horizontal" style="text-align: left;" action="userc.php" method="POST">
                                <div class="row">
                                    <div class="col-xs-4">
                                        ...
                                        if (count($_COOKIE) > 0) {
                                            ...
                                            if (isset($data['cedula']) and strlen($data['cedula']) > 0) {
                                                ...
                                                <div class="alert alert-warning alert-dismissible espacio_cookie" role="alert">
                                                    <a class="close" href="userc.php?ccedula=<?php echo $data['cedula']; ?>">&times;</a>                        
                                                    <?php
                                                    echo "C&eacute;dula: ";
                                                    echo $data['cedula'];
                                                    $BAND_COOKIE = true;
                                                ...
                                                <div class="alert alert-warning alert-dismissible espacio_cookie" role="alert">
                                                    <a class="close" href="userc.php?ccedula=<?php echo $_COOKIE['cedula']; ?>">&times;</a>                        
                                                    <?php
                                                    echo "C&eacute;dula: ";
                                                    echo $_COOKIE["cedula"];
                                                    $BAND_COOKIE = true;
                                                ...
                                                ?>
                                                <div class="alert alert-warning alert-dismissible espacio_cookie" role="alert">
                                                    <a class="close" href="userc.php?cpnombre=<?php echo $data['pnombre']; ?>">&times;</a>                        
                                                    <?php
                                                    echo "Primer nombre: ";
                                                    echo $data['pnombre'];
                                                    $BAND_COOKIE = true;
                                                ...
                                                <div class="alert alert-warning alert-dismissible espacio_cookie" role="alert">
                                                    <a class="close" href="userc.php?cpnombre=<?php echo $_COOKIE['pnombre']; ?>">&times;</a>                        
                                                    <?php
                                                    echo "Primer nombre: ";
                                                    echo $_COOKIE["pnombre"];
                                                    $BAND_COOKIE = true;
                                                ...
                                                ?>
                                                <div class="alert alert-warning alert-dismissible espacio_cookie" role="alert">
                                                    <a class="close" href="userc.php?csnombre=<?php echo $data['snombre']; ?>">&times;</a>                        
                                                    <?php
                                                    echo "Segundo nombre: ";
                                                    echo $data['snombre'];
                                                    $BAND_COOKIE = true;
                                                ...
                                                <div class="alert alert-warning alert-dismissible espacio_cookie" role="alert">
                                                    <a class="close" href="userc.php?csnombre=<?php echo $_COOKIE['snombre']; ?>">&times;</a>                        
                                                    <?php
                                                    echo "Segundo nombre: ";
                                                ...
                                                ?>
                                                <div class="alert alert-warning alert-dismissible espacio_cookie" role="alert">
                                                    <a class="close" href="userc.php?cpapellido=<?php echo $data['papellido']; ?>">&times;</a>                        
                                                    <?php
                                                ...
                                                <div class="alert alert-warning alert-dismissible espacio_cookie" role="alert">
                                                    <a class="close" href="userc.php?cpapellido=<?php echo $_COOKIE['papellido']; ?>">&times;</a>                        
                                                    <?php
                                                    echo "Primer apellido: ";
                                                ...
                                                ?>
                                                <div class="alert alert-warning alert-dismissible espacio_cookie" role="alert">
                                                    <a class="close" href="userc.php?csapellido=<?php echo $data['sapellido']; ?>">&times;</a>                        
                                                    <?php
                                                ...
                                                <div class="alert alert-warning alert-dismissible espacio_cookie" role="alert">
                                                    <a class="close" href="userc.php?csapellido=<?php echo $_COOKIE['sapellido']; ?>">&times;</a>                        
                                                    <?php
                                                    echo "Primer apellido: ";
                        ...
                        <div id="menu1" class="tab-pane fade">
                            <form name="form2" class="form-horizontal" style="text-align: left;" action="userc.php" method="POST">
